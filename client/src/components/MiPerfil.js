export default function MiPerfil() {
    ...
    <div style="background-color : #f4f4f0" className=" sm:mx-32 lg:mx-32 xl:mx-72 ">
    <div className="flex justify-between container mx-auto">
    <div className="w-full">
    <div className="mt-4 px-4">
    <h1 className="text-3xl font-semibold py-7 px-5">addbyme</h1>
    <h1 className="font-thinner flex text-4xl pt-10 px-5">Setup Your ABM Id</h1>
    ...
    <span className="flex-none text-dusty-blue-darker select-none leading-none">addby.me/
    </span>
